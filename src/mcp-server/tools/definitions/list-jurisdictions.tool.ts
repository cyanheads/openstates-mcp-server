                ...
                z
                  .object({
                    ...
                    classification: z
                      .string()
                      .describe(
                        'Session type: "primary", "special", etc. Empty string when Open States recorded none, which covers 28% of sessions — 13 jurisdictions carry no classification on any session at all.',
                      ),
                    start_date: z
                      .string()
                      .describe(
